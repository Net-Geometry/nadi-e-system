  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">        <div className="flex justify-between items-center">
          <div>            <h1 className="text-xl font-bold">Human Resources: Staff Report</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-6">
          ...
          <Card className="overflow-hidden shadow-sm border border-gray-200 lg:col-span-3">
            <CardHeader className="p-4 bg-white border-b">
              <CardTitle className="text-lg font-medium text-gray-800">Staff Processing</CardTitle>
            </CardHeader>
            <CardContent className="p-6 bg-white">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-gray-600 font-medium">NADI Site Coverage</span>
              </div>
              <div className="flex items-center justify-center">
                <div className="text-center">
                  <div className="text-4xl font-bold text-gray-800 mb-2">12</div>
                  <div className="text-base font-medium text-gray-600 mb-1">Active NADI Sites</div>
          ...
          <Card className="overflow-hidden shadow-sm border border-gray-200 lg:col-span-2">
            <CardHeader className="p-4 bg-white border-b">
              <CardTitle className="text-lg font-medium text-gray-800">Performance Recognition</CardTitle>
            </CardHeader>
            <CardContent className="p-6 bg-white">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-gray-600 font-medium">Site Participation</span>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-gray-800 mb-2">8</div>
                <div className="text-sm text-gray-500">NADI sites participating in<br />staff recognition program</div>
              </div>
            </CardContent>
          </Card>
